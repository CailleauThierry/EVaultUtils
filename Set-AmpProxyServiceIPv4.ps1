...
# tested to work with PS v3, fails with v2 with following error:
#>> Platform: V2 64Bit (STA)
#ERROR: Replace : Method invocation failed because [System.Object[]] doesn't contain a method named 'Replace'.
#ERROR:
#Set-AmpProxyServiceIPv4.ps1 (41, 18): ERROR: At Line: 41 char: 18
#ERROR: + $AMPProxy.Replace <<<< ("$OldLine", "$NewLine") | Out-File -FilePath "C:\Program Files\EVault Software\Portal Services\AMP Proxy Service\AmpService.exe.confi
#ERROR: g" -Force
